...
import cv2 as cv
import numpy as np
from edge_enhancement import enhancement
import opts
import sys
...
def processing(img_path):
    ...
    image = cv.resize(image, (opt.img_width,opt.img_height))
...
if __name__ == "__main__":
    ...
    input_path = "/Users/qiankudawang/code/Chinese-Landscape-Painting-Style-Transfer/All-Paintings" #输入路径
